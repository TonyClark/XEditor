...
public class Thread implements java.io.Serializable, StackFrame {
	...
	public Thread(String name, ValueStack stack, int currentFrame, int openFrame, ThreadInitiator initiator,
	...
	public Vector<String> localNames(Machine machine, int frame) {
		...
		for (int i = 0; i < locals; i++) {
			...
			if (localName != Machine.undefinedValue)
				localNames.add(machine.valueToString(localName));
		}
		return localNames;
	...
	public String toString() {
		return "Thread(" + name + "," + id + "," + stateToString() + "," + currentFrame + "," + classLoader + ","
				+ client + ")";
	}
