...
/******************************************************************************
 * * VM Values * ------------------------------------------------ * * The VM implements a tagged architecture. All values are machine words * consisting of a tag and a value. The tag is an 8-bit value
 * that determines* the type of the value. This file defines the type tags and the associated * constants. * *
 ******************************************************************************/
...
public interface Value {
	...
	public static final int BIGINT = 34; // Arbitrary precision integers.

	public static final int LASTVALUE = 35; // The first unused type tag.
	...
	public static String typeName(int i) {
		for(Field field : Value.class.getFields()) {
			int index = -1;
			try {
