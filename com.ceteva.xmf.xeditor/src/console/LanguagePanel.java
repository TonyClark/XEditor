...
public class LanguagePanel extends JPanel {
	...
	private static final String defaultLanguage = "XOCL";
	private static final String defaultNT = "CompilationUnit";

	private Console console;
	private JLabel language = new JLabel("language");
	private JLabel languageName = new JLabel(defaultLanguage);
	...
	public void setLanguage(String language) {
		languageName.setText(language.equals("OCL::OCL") ? "XOCL" : language);
	}
