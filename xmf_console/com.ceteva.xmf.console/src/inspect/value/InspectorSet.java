...
import inspect.SetCellEditor;

public class InspectorSet extends InspectorValue {

	private Vector<InspectorValue> values;
	private SetCellEditor editor = null;

	public InspectorSet(Vector<InspectorValue> values) {
		super();
		this.values = values;
		this.editor = new SetCellEditor(values);
	}
