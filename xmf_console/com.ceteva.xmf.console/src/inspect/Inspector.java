...
public class Inspector extends JInternalFrame implements MouseListener {

	private static final int NEAR = 50;

	public static Inspector mkInspector(String snapshot, int objectHandle, String objectLabel, int classHandle,
			String classLabel, Vector<InspectorField> fields, boolean isClass, boolean satisfied, String report) {
		Inspector inspector = InspectorManager.MANAGER.getInspector(objectHandle, snapshot);
		if (inspector != null) {
			...
			Inspector i = new Inspector(snapshot, objectHandle, objectLabel, classHandle, classLabel, fields, isClass,
					satisfied, report);
	...
	public Inspector(String snapshot, int objectHandle, String objectLabel, int classHandle, String classLabel,
